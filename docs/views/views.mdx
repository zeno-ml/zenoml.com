...
<table>
  ...
  <tr>
    ...
    <td>
      Show input-output pairs from chatbot models using the OpenAI API. See the{" "}
      <a href="https://platform.openai.com/docs/guides/chat">API documentation</a> for
      details on the required Chat data format. <br />
      This view is similar to the `openai-chat` view, but it renders assistant blocks and
      labels with markdown syntax to enable representing more complex queries like tools.
    </td>
  </tr>
  <tr>
    <td>chatbot</td>
