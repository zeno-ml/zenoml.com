...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      This view is similar to the `openai-chat` view, but it renders assistant blocks with markdown syntax to enable representing more complex queries like tools.
    </td>
  ...
  <tr>
    ...
    <td>Table view of inputs, outputs, and labels which are space-separated words. Useful for tasks such as part-of-speech tagging.</td>
  </tr>
</table>
