...
<img style={{borderRadius: '5px', margin: '5px', width: '50%', marginRight: '20px', objectFit: 'contain'}} src="/img/explore.png" />
<div>
<p>
...
<div style={{ display: "flex" }}>
  ...
  />
  <p>
    The Report page is used to compare models across slices. You can create
    reports for groups of instance and see how new models compare with sparkline
    visualizations and trends. To catch potential regressions, you can create
    tests of expected metrics for slices. Reports can be shared and exported as
    PDFs.
  </p>
</div>
