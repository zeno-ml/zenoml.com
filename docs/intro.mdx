...
We can now initialize a client with our API key which we will useto create projects and upload data.
...
:::tip
Learn more about Zeno's `view` options in the [instance view docs](/docs/views).
